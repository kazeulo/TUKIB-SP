...
\chapter{Results and Sytem Features}
...
Figure \ref{fig:news_page} is the 'News and Announcements' page. This page serves as the central hub for all important updates related to the RRC, including news about upcoming events, recent developments, announcements of new equipment or services, and relevant research highlights.
...
On of the core features of TUKIB is the Service Request Module, which allows clients to easily submit service requests. Staff can view, track, and manage all types of requests, updating their statuses and ensuring each request is processed efficiently from request to completion. This module also ensures that all data is centralized, providing a unified view of requests for better coordination among staffs and streamlined workflows. 
