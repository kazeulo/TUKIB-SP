...
\figref{fig:use_case} presents the use case diagram of the system, which visually represents the key interactions between different types of users and the system in the service management cycle of the UPV RRC. The diagram highlights the various roles and their associated tasks in managing service requests.

\begin{figure}[h]
	\centering 
	\includegraphics[width=1\textwidth]{use_case.jpg}
