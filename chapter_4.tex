...
\begin{figure}[h]
	\centering 
	\includegraphics[width=0.9\textwidth]{staff_dashboard.png}
...
\begin{figure}[h]
	\centering 
	\includegraphics[width=0.9\textwidth]{client_dashboard.png}
