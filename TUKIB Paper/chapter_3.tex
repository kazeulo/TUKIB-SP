...
\begin{itemize}
	...
	\item \textbf{User Testing.} Due to time and technical constraints, nstead of automated testing, the developers conducted manual user testing throughout the development process. This involved simulating different user scenarios to validate each feature’s functionality, usability, and consistency. The tests ensured that the system behaved as expected under normal and edge-case conditions, helping to catch bugs early and refine the interface for a smoother user experience.
