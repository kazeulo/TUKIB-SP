...
\begin{itemize}
	...
	Throughout the course of development of TUKIB there has been changes in the service flow of the RRC. Hence, it is highly recommended to conduct another round of data gathering, through comprehensive interview with the stakeholders and updated user stories. This will ensure that TUKIB remains aligned with the current operational workflow of the RRC.
