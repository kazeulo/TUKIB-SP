...
To reinforce this requirement, as shown on figure \figref{fig:signup_popup}, a pop-up reminder is shown when the sign-up page loads, displaying a message that reminds users that before signing up, they are to make sure they have completed the initial consultation with RRC and that this step is required to proceed with account creation.
...
\begin{itemize}
    ...
    \item Do you think the instructions and tooltips were helpful?
