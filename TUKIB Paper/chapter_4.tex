...
Once all the initially identified requirements had been implemented, the complete system was presented to the staff of the RRC. The purpose was to verify that the system aligns with the needs of the institution and to gather feedback and suggestions for improvement. The insights of staffs were used to refine certain components of the system, particularly those related to service workflows.
