...
Upon clicking the button, the chatbot initiates the conversation by presenting a welcome message, as shown in \figref{fig:chatbot_ui}. After which, it will offer a set of predefined options to help users with possible queries.
...
To prevent data loss in scenarios of data breach, automatic archiving and backuping were implmented. This is to ensure that the data can be recovered.

\section{Testing}

System testing was conducted alongside the development process to ensure functionality and usability. This included manual testing of system features to identify and resolve bugs during implementation.

In addition, the system was presented to the staff of the RRC to verify alignment with institutional requirements and to gather feedback and suggestions for improvement. Their insights were used to refine certain components of the system, particularly those related to service workflows.

The system was also tested by potential end users—individuals who could serve as future clients of the RRC. These users evaluated the system performance and interface for usability, intuitiveness, and user experience. 

Overall, feedback from these sessions indicated a generally positive reception. RRC staff indicated that the system can significantly helped in the efficiency of their service delivery, as well as, resource and data management. While end users find the system easy to navigate, intuitive, and user-friendly. 

\section{Summary of Results}

To summarize the results of the study, the checklist of system requirements, Table \ref{tab:requirements}, was updated to indicate whether each requirement for TUKIB has been implemented. As shown in the Table \ref{tab:summary_results}, all of the system requirements have been successfully accomplished, demonstrating that the core functionalities of TUKIB are in place. Moreover, based on the feedback from testing, the final output of this paper was agreed to meet the requirements needed by the users, especially by the RRC staff.
