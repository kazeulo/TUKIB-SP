...
The developers will begin the project by visiting the UPV RRC, where they will conduct interviews with stakeholders. This phase is crucial for understanding the specific needs of the institution and planning the features of the system accordingly. The data gathered during these interviews will inform the subsequent processes of the project, ensuring that the system is tailored to meet the requirements and expectations of its users.\newline
